...
Describe your results and key findings. Drop any images or GIFs into `assets/` and reference them with a relative path:

```
![my result](assets/demo.gif)
```

Source files live in `code/` and can be linked the same way:

```
[View source](code/solution.py)
```
